package com.example.nero.neuroimpl
...
object BrainBitController {
    ...
    private var sensor: BrainBit? = null
    ...
    fun createAndConnect(sensorInfo: SensorInfo, onConnectionResult: (SensorState) -> Unit){
        thread {
            try {
                sensor = scanner!!.createSensor(sensorInfo) as BrainBit
    ...
    fun startSignal(signalReceived: (Array<BrainBitSignalData>) -> Unit){
        sensor!!.brainBitSignalDataReceived = BrainBitSignalDataReceived(signalReceived)
    ...
    fun startResist(resistReceived: (BrainBitResistData) -> Unit){
        sensor!!.brainBitResistDataReceived = BrainBitResistDataReceived(resistReceived)
